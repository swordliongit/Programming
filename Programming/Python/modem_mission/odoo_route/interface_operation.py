...
def interface_operation_read(driver: webdriver, queue):
    ...
    ############################# XXX
    print("Operation launched...")
    ############################# XXX
    
    obj_dict =  {"id":43,"jsonrpc":"2.0","method":"call","params":{
        "args":[
            {"partner_gid":0,"additional_info":False,"image_1920":False,"__last_update":False,"is_company":False,"active":True,"company_type":"person","name":"proto5","parent_id":False,"company_name":False,"type":"contact","street":False,"street2":False,"city":False,"state_id":False,"zip":False,"country_id":False,"vat":False,         
    ...
    if x_enable_wireless:
        ...
        field_dict['x_enable_ssid1'] = "-"
        field_dict['x_enable_ssid2'] = "-"
        field_dict['x_enable_ssid3'] = "-"
        field_dict['x_enable_ssid4'] = "-"
    ...
    for i, v in field_dict.items():
        obj_dict['params']['args'][0].update({i:v}) # add newly fetched fields into the main dict
