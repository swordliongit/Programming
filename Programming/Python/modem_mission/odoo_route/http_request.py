...
def fetch_datafrom_odoo():
    ...
    myobj = {"id":39,"jsonrpc":"2.0","method":"call","params":{"model":"modem.profile","domain":[["x_device_update","=",True]],"fields":["x_uptime","x_wireless_status","x_channel","x_mac","x_device_info","x_ip","x_subnet","x_dhcp","x_enable_wireless","x_enable_ssid1","x_enable_ssid2","x_enable_ssid3","x_enable_ssid4","x_manual_time","x_new_password","name","modem_status","city","live_status"],"limit":80,"sort":"live_status DESC","context":{"lang":"en_US","tz":"Europe/Istanbul","uid":2,"allowed_company_ids":[1],"bin_size":True}}}
